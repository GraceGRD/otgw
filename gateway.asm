...
TreatMessage	btfsc	byte2,7
		goto	VendorMessage	;Limited support for Vender specific ID
		movfw	byte2
		brw
...
VendorMessage	movf byte2,W		;Load ID byte to working register
		xorlw 	130					;Goto to VendorMessageID130 if id is 130
		skpnz
		goto	VendorMessageID130		
		movf 	byte2,W				;Re-load ID byte to working register
		xorlw 	133					;Goto to VendorMessageID130 if id is 130
		skpnz
		goto	VendorMessageID133
		goto 	WordResponse		;Default to WordResponse for unknown IDs
